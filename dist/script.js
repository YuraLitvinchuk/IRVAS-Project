...
/* harmony import */ var _checkNumIputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumIputs */ "./src/js/modules/checkNumIputs.js");



var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll(".balcons_icons_img"),
      windowWidth = document.querySelectorAll("#width"),
      windowHeight = document.querySelectorAll("#height"),
      windowType = document.querySelectorAll("#view_type"),
      windowProfile = document.querySelectorAll(".checkbox");
  Object(_checkNumIputs__WEBPACK_IMPORTED_MODULE_1__["default"])("#width");
  Object(_checkNumIputs__WEBPACK_IMPORTED_MODULE_1__["default"])("#height");
...
/* harmony import */ var _checkNumIputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNumIputs */ "./src/js/modules/checkNumIputs.js");
...
var forms = function forms(state) {
  ...
  Object(_checkNumIputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: "Загрузка...",
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      e.preventDefault();
      var statusMeassage = document.createElement("div");
...
var modals = function modals() {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      document.body.style.overflow = "hiddeen";
    }, time);
  }
...
var tabs = function tabs(headerSelector, tabSelector, contnentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "block";
  var header = document.querySelector(headerSelector),
      tab = document.querySelectorAll(tabSelector),
      content = document.querySelectorAll(contnentSelector);
